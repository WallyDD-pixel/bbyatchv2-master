  ...
  return (
    <section id="experiences" className="w-full max-w-6xl mx-auto mt-12 sm:mt-16 px-2 sm:px-0">
      <div className="text-center">
        <h2 className="text-2xl sm:text-4xl font-extrabold text-black/90">{headline}</h2>
        <h3 className="mt-2 sm:mt-3 text-xl sm:text-2xl font-bold text-black/80">{sectionTitle}</h3>
      </div>
