  ...
  return (
    <section className="w-full py-12 md:py-16 lg:py-20">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        {title && <h2 className="text-2xl md:text-3xl font-display font-bold mb-3 text-slate-800 dark:text-slate-100">{title}</h2>}
        {subtitle && <p className="text-sm md:text-base font-montserrat text-slate-600 dark:text-slate-300 mb-6 max-w-3xl">{subtitle}</p>}
