...
// Icônes SVG pour les réseaux sociaux (uniformes - 20x20)
const LinkedInIcon = () => (
...
export default async function Footer({ locale, t }: { locale: Locale; t: Record<string, string> }) {
  ...
  const facebookUrl = (s as any)?.footerFacebook || null;
  const linkedInUrl = (s as any)?.footerLinkedIn || null;
  const youTubeUrl = (s as any)?.footerYouTube || null;
  const tikTokUrl = (s as any)?.footerTikTok || null;
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-12">
        ...
        <div className="grid gap-12 md:grid-cols-4 md:gap-6 lg:gap-8">
          ...
          <div className="md:col-span-1">
            ...
            {/* Réseaux sociaux avec espacement uniforme - affichage conditionnel */}
            {(instagramUrl || facebookUrl || linkedInUrl || youTubeUrl || tikTokUrl) && (
              <div className="mt-5 flex items-center gap-3">
                {instagramUrl && (
                  <a 
                    ...
                    className="inline-flex items-center justify-center w-8 h-8 text-[#999999] hover:text-[#E4405F] transition-colors duration-200"
                    title="Instagram"
                  >
                    <InstagramIcon />
                  </a>
                ...
                {facebookUrl && (
                  <a 
                    ...
                    rel="noopener noreferrer"
                    aria-label="Facebook" 
                    className="inline-flex items-center justify-center w-8 h-8 text-[#999999] hover:text-[#1877F2] transition-colors duration-200"
                    title="Facebook"
                  >
                    <FacebookIcon />
                  </a>
                ...
                {linkedInUrl && (
                  <a 
                    ...
                    rel="noopener noreferrer"
                    aria-label="LinkedIn" 
                    className="inline-flex items-center justify-center w-8 h-8 text-[#999999] hover:text-[#0A66C2] transition-colors duration-200"
                    title="LinkedIn"
                  >
                    <LinkedInIcon />
                  </a>
                ...
                {youTubeUrl && (
                  <a 
                    ...
                    rel="noopener noreferrer"
                    aria-label="YouTube" 
                    className="inline-flex items-center justify-center w-8 h-8 text-[#999999] hover:text-[#FF0000] transition-colors duration-200"
                    title="YouTube"
                  >
                    <YouTubeIcon />
                  </a>
                ...
                {tikTokUrl && (
                  <a 
                    ...
                    rel="noopener noreferrer"
                    aria-label="TikTok" 
                    className="inline-flex items-center justify-center w-8 h-8 text-[#999999] hover:text-black transition-colors duration-200"
                    title="TikTok"
                  >
                    <TikTokIcon />
                  </a>
