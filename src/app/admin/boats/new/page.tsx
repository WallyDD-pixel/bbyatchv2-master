          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4">
              <label className="grid gap-1 text-sm">
                ...
                <input name="sort" type="number" min="0" defaultValue="0" className="h-11 rounded-lg border border-black/15 px-3 w-full" />
                <p className="text-xs text-black/50">{locale === "fr" ? "Plus bas = affiché en premier." : "Lower = shown first."}</p>
              </label>
              <label className="grid gap-1 text-sm">
