...
export default function AdminSocialMediaContent({ initialLocale }: { initialLocale: Locale }) {
  ...
  return (
    <main className="flex-1 max-w-3xl mx-auto px-4 py-10 w-full">
      <Link href="/admin" className="mb-6 inline-block text-sm rounded-full border-2 border-blue-400 px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 font-medium">
